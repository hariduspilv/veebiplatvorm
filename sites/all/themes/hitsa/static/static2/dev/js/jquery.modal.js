	...
	function appendContent(){
		...
		if( type == "image" ){
			output+=	'<div class="block">';
				...
				output+= '<div class="btn-bar align-right"> <a href="javscript:void(0);" class="btn-circle before-share" data-plugin="share"></a> <a href="javascript:window.print();" class="sm-hide btn-circle before-print"></a> </div><div class="row-spacer">&nbsp;</div>';
